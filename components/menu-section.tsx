    ...
    <section id="menu" className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#fbf9f4] border-b border-gray-200">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          {/* Inline Search Toggle on Desktop / Mobile */}
          <div className="relative flex items-center">
            <div className={`relative transition-all duration-200 ${isSearchOpen || searchQuery ? 'w-full md:w-72' : 'w-full md:w-64'}`}>
              ...
              <input
                ...
                className="w-full pl-10 pr-9 py-2 rounded-full bg-white border border-gray-200 text-xs font-medium text-[#102341] placeholder:text-gray-400 focus:outline-none focus:border-[#102341] shadow-xs transition-all"
              />
              {searchQuery && (
                <button
        ...
        {/* Compact Horizontal Category Bar (1 Row) */}
          ...
          {MENU_CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-bold whitespace-nowrap transition-all select-none ${
                  isActive
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  onClick={() => setSelectedItem(null)}
                  className="p-1.5 rounded-full text-gray-400 hover:text-[#102341] hover:bg-gray-100 transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="pt-2">
                <button
                  onClick={() => setSelectedItem(null)}
                  className="btn-chamberlain-primary w-full py-3 text-xs tracking-wider justify-center"
                >
                  Kapat
                </button>
              </div>
